...
const pools = {
  freelance_admin:      makePool('freelance_admin',      process.env.DB_PASS_ADMIN),
  freelance_client:     makePool('freelance_client',     process.env.DB_PASS_CLIENT),
  freelance_contractor: makePool('freelance_contractor', process.env.DB_PASS_CONTRACTOR),
  freelance_guest:      makePool('freelance_guest',      process.env.DB_PASS_GUEST),
}
